...
public class YunpianApiUtil {
	 ...
	 * apikey
	 */
	private static String apikey = "340392d13d5a25c5eddebb9c2364eaab";
	...
	public static String getToken() throws Exception{
		HttpClient client = new HttpClient();
		NameValuePair[] nameValuePairs = new NameValuePair[3];
		nameValuePairs[0] = new NameValuePair("grant_type", "client_credentials");
		nameValuePairs[1] = new NameValuePair("client_id", "YXA6CbxmcABKEeWmV885Ltj-pQ");
		nameValuePairs[2] = new NameValuePair("client_secret", "YXA6LWr0PY2f9LqntRfdjTxl2dQTApw");
		PostMethod method = new PostMethod("https://a1.easemob.com/guobi/kdwork/token");
	    method.setRequestBody("{\"grant_type\":\"client_credentials\",\"client_id\":\"YXA6CbxmcABKEeWmV885Ltj-pQ\",\"client_secret\": \"YXA6LWr0PY2f9LqntRfdjTxl2dQTApw\"}");
	...
	System.out.println(YunpianApiUtil.getToken());
	//	System.out.println(YunpianApiUtil.sendSms("您的验证码是1234【乐非凡】", "18316611057"));
	//	System.out.println(YunpianApiUtil.tplSendSms(1, "#code#=1234&#company#="+URLEncoder.encode("乐非凡"), "18316611057"));
